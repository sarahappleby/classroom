...
% Define our own symbols
% \newcommand{\msolar}{\;{\rm M}_{\odot}}
% \newcommand{\angstrom}{\textup{\AA}}
% \newcommand{\mgcha}{${\rm Mg\ C\ ha}^{-1}$}
...
% ----- Our own symbols examples -----

% The Sentinel-2 green band has a central wavelength of 560nm, or $5600\angstrom$.

% One solar mass is $\msolar = 2\times10^{30}{\rm kg}$; the black hole at the center of the Milky Way has a mass of $4.3\times10^6\msolar$.

% The AOI has an average of 100 \mgcha.
